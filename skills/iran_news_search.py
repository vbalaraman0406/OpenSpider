...
searches = [
    'https://html.duckduckgo.com/html/?q=Iran+war+conflict+news+today+March+2026',
    'https://html.duckduckgo.com/html/?q=Iran+military+attack+news+today+2026',
    'https://html.duckduckgo.com/html/?q=Iran+US+military+news+latest+March+2026',
]
...
for i, r in enumerate(all_results):
    ...
    print(f"Snippet: {r.get('snippet', 'N/A')[:200]}")

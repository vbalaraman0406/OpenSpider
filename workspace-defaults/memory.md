...
- **File attachments**: Users can attach images and files via the web dashboard chat. Images are analyzed via multimodal LLM.

## User Preferences

- (Add your name, email, and preferences here after first run)
